...
if __name__ == '__main__':
    ...
    parser.add_argument("--iterators",default=20000,type=int)
    ...
    parser.add_argument("--savedir",default='ckpt/adain_content1_style1e-2_20000_为了tensorboard',type=str)
    parser.add_argument("--logdir",default='logfile/adain_content1_style1e-2_20000_为了tensorboard',type=str)
    parser.add_argument("--reusedir", default='ckpt/adain_content1_style1e-2_160000', type=str)
